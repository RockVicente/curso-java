 ...
 */
package rockvicente.condicaoswing;

/**
 *
 * @author LENOVO
 */
public class CondicaoSwing extends javax.swing.JFrame {

    /**
     * Creates new form CondicaoSwing
     */
    public CondicaoSwing() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnVerificar.setForeground(new java.awt.Color(102, 102, 102));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CondicaoSwing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CondicaoSwing().setVisible(true);
            }
        });
    }
